...
func TestActionRunner(t *testing.T) {
	...
	for _, tt := range table {
		t.Run(tt.name, func(t *testing.T) {
			...
			cm := &containerMock{}
			cm.On("CopyDir", "/var/run/gha/actions/dir/", "dir/", false).Return(func(_ context.Context) error { return nil })
			...
			cm.On("Exec", []string{"node", "/var/run/gha/actions/dir/path"}, envMatcher, "", "").Return(func(_ context.Context) error { return nil })
