...
func TestRunEvent(t *testing.T) {
	...
	tables := []TestJobFileInfo{
		...
		// {workdir, "shells/custom", "push", "", map[string]string{"ubuntu-latest": "milan98080/ubuntu:pwsh-latest"}, }, // custom image with pwsh
		{workdir, "shells/pwsh", "push", "", map[string]string{"ubuntu-latest": "milan98080/ubuntu:pwsh-latest"}, secrets}, // custom image with pwsh
		...
		{workdir, "gha-composite-env-test", "push", "", platforms, secrets},
		...
		{workdir, "if-env-gha", "push", "", platforms, secrets},
