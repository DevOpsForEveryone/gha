...
func TestDockerCopyTarStream(t *testing.T) {
	...
	client.On("CopyToContainer", ctx, "123", "/var/run/gha", mock.Anything, mock.AnythingOfType("container.CopyToContainerOptions")).Return(nil)
	cr := &containerReference{
		id:  "123",
		cli: client,
		input: &NewContainerInput{
	...
	_ = cr.CopyTarStream(ctx, "/var/run/gha", &bytes.Buffer{})
...
func TestDockerCopyTarStreamDryRun(t *testing.T) {
	...
	client.AssertNotCalled(t, "CopyToContainer", ctx, "123", "/var/run/gha", mock.Anything, mock.AnythingOfType("container.CopyToContainerOptions"))
	cr := &containerReference{
		id:  "123",
		cli: client,
		input: &NewContainerInput{
...
func TestDockerCopyTarStreamErrorInCopyFiles(t *testing.T) {
	...
	err := cr.CopyTarStream(ctx, "/var/run/gha", &bytes.Buffer{})
...
func TestDockerCopyTarStreamErrorInMkdir(t *testing.T) {
	...
	client := &mockDockerClient{}
	client.On("CopyToContainer", ctx, "123", "/", mock.Anything, mock.AnythingOfType("container.CopyToContainerOptions")).Return(nil)
	client.On("CopyToContainer", ctx, "123", "/var/run/gha", mock.Anything, mock.AnythingOfType("container.CopyToContainerOptions")).Return(merr)
	cr := &containerReference{
		id:  "123",
		cli: client,
		input: &NewContainerInput{
